...
CJK_OUTPUT_PATH="${FIRMWARE_DIR}/components/ui/fonts/desk_ui_cjk_font_16.c"
...
npx --yes lv_font_conv@1.5.3 \
    ...
    --no-kerning \
    --lv-include "lvgl.h" \
    --lv-font-name desk_ui_cjk_font_16 \
    -o "components/ui/fonts/desk_ui_cjk_font_16.c"
...
npx --yes lv_font_conv@1.5.3 \
    ...
    --lv-fallback desk_ui_cjk_font_16 \
    -o "components/ui/fonts/desk_ui_font_16.c"

echo "已生成 ${CJK_OUTPUT_PATH}，覆盖完整东亚常用字符区。"
